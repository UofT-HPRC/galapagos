...
proc create_hier_cell_network { parentCell nameHier } {
  ...
  set network_packet_fifo_1 [ create_bd_cell -type ip -vlnv dlyma.org:dlyma:network_packet_fifo_tx:1.1 network_packet_fifo_1 ]
...
proc create_hier_cell_mem_interface { parentCell nameHier } {
  ...
  set ddr0_interconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 ddr0_interconnect ]
  set_property -dict [ list \
  ...
  set ddr1_interconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 ddr1_interconnect ]
  set_property -dict [ list \
   CONFIG.ENABLE_ADVANCED_OPTIONS {1} \
   CONFIG.M00_HAS_REGSLICE {3} \
   CONFIG.NUM_MI {1} \
  ...
  set ddr_aresetn [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 ddr_aresetn ]
  set_property -dict [ list \
  ...
  set ddr_aux_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 ddr_aux_reset ]
  set_property -dict [ list \
  ...
  set ddr_proc_sys_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 ddr_proc_sys_reset ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net c0_sys_clk_1 [get_bd_intf_pins c0_sys_clk] [get_bd_intf_pins ddr4_0/C0_SYS_CLK]
  connect_bd_intf_net -intf_net c1_sys_clk_1 [get_bd_intf_pins c1_sys_clk] [get_bd_intf_pins ddr4_1/C0_SYS_CLK]
  connect_bd_intf_net -intf_net ddr0_interconnect_M00 [get_bd_intf_pins ddr0_interconnect/M00_AXI] [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI]
  connect_bd_intf_net -intf_net ddr1_interconnect_M00 [get_bd_intf_pins ddr1_interconnect/M00_AXI] [get_bd_intf_pins ddr4_1/C0_DDR4_S_AXI]
  ...
  # Create port connections
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins ddr0_interconnect/M00_ARESETN] [get_bd_pins ddr1_interconnect/M00_ARESETN] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins ddr4_1/c0_ddr4_aresetn] [get_bd_pins ddr_proc_sys_reset/peripheral_aresetn]
  connect_bd_net -net S00_ACLK_1 [get_bd_pins PCIE_ACLK] [get_bd_pins ddr0_interconnect/S01_ACLK]
  connect_bd_net -net S01_ARESETN_1 [get_bd_pins S_ARESETN] [get_bd_pins ddr0_interconnect/S00_ARESETN] [get_bd_pins ddr0_interconnect/S01_ARESETN] [get_bd_pins ddr1_interconnect/S00_ARESETN]
  ...
  connect_bd_net -net ddr4_0_c0_init_calib_complete [get_bd_pins ARESETN] [get_bd_pins ddr_aresetn/Res] [get_bd_pins ddr_proc_sys_reset/ext_reset_in]
  connect_bd_net -net ddr4_0_c0_init_calib_complete1 [get_bd_pins ddr4_0/c0_init_calib_complete] [get_bd_pins ddr_aresetn/Op1]
  connect_bd_net -net ddr4_1_c0_ddr4_ui_clk [get_bd_pins ddr0_interconnect/ACLK] [get_bd_pins ddr0_interconnect/M00_ACLK] [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins ddr_proc_sys_reset/slowest_sync_clk]
  connect_bd_net -net ddr4_1_c0_ddr4_ui_clk1 [get_bd_pins ddr1_interconnect/ACLK] [get_bd_pins ddr1_interconnect/M00_ACLK] [get_bd_pins ddr4_1/c0_ddr4_ui_clk]
  ...
  connect_bd_net -net m_axi_mm2s_aclk_1 [get_bd_pins clk156_25] [get_bd_pins ddr0_interconnect/S00_ACLK] [get_bd_pins ddr1_interconnect/S00_ACLK]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins ddr0_interconnect/ARESETN] [get_bd_pins ddr1_interconnect/ARESETN] [get_bd_pins ddr_proc_sys_reset/interconnect_aresetn]
  connect_bd_net -net sys_rst_1 [get_bd_pins sys_rst] [get_bd_pins ddr4_0/sys_rst] [get_bd_pins ddr4_1/sys_rst]
  connect_bd_net -net util_vector_logic_4_Res [get_bd_pins ddr_aux_reset/Res] [get_bd_pins ddr_proc_sys_reset/aux_reset_in]
...
proc create_hier_cell_mb_system { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Clk_1 [get_bd_pins clk100] [get_bd_pins mdm_0/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_0_M02_AXI] [get_bd_intf_ports M_AXI_CONTROL] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  connect_bd_intf_net -intf_net c0_sys_clk_1 [get_bd_intf_ports c0_sys_clk] [get_bd_intf_pins mem_interface/c0_sys_clk]
  connect_bd_intf_net -intf_net c1_sys_clk_1 [get_bd_intf_ports c1_sys_clk] [get_bd_intf_pins mem_interface/c1_sys_clk]
  connect_bd_intf_net -intf_net diff_clock_rtl_1 [get_bd_intf_ports diff_clock_rtl] [get_bd_intf_pins PCIe/CLK_IN_D]
  connect_bd_intf_net -intf_net mem_interface_c0_ddr4 [get_bd_intf_ports c0_ddr4] [get_bd_intf_pins mem_interface/c0_ddr4]
  connect_bd_intf_net -intf_net mem_interface_c1_ddr4 [get_bd_intf_ports c1_ddr4] [get_bd_intf_pins mem_interface/c1_ddr4]
