...
create_bd_cell -type ip -vlnv xilinx.com:hls:kern_send applicationRegion/kern_send_inst_0
# /middleware/python/tclFileGenerator.py:357
connect_bd_net [get_bd_ports CLK] [get_bd_pins applicationRegion/kern_send_inst_0/ap_clk]
# /middleware/python/tclFileGenerator.py:357
connect_bd_net [get_bd_ports ARESETN] [get_bd_pins applicationRegion/kern_send_inst_0/ap_rst]
# /middleware/python/tclFileGenerator.py:357
...
# /middleware/python/tclFileGenerator.py:357
connect_bd_net [get_bd_ports ARESETN] [get_bd_pins applicationRegion/myproject_galapagos_inst_1/ap_rst]
...
# /middleware/python/tclFileGenerator.py:698
set_property -dict [list CONFIG.NUM_SI {2} CONFIG.NUM_MI {2} CONFIG.ARG_ON_TLAST {1} ] [get_bd_cells applicationRegion/input_switch]
# /middleware/python/tclFileGenerator.py:698
...
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x00000000} CONFIG.M00_AXIS_HIGHTDEST {0x00000000} CONFIG.M01_AXIS_BASETDEST {0x00000001} CONFIG.M01_AXIS_HIGHTDEST {0x00000001} ] [get_bd_cells applicationRegion/input_switch]
# /middleware/python/tclFileGenerator.py:758
create_bd_cell -type ip -vlnv xilinx.com:ip:axis_switch applicationRegion/output_switch
# /middleware/python/tclFileGenerator.py:758
set_property -dict [list CONFIG.NUM_SI {2} CONFIG.NUM_MI {1} CONFIG.ARG_ON_TLAST {1} CONFIG.M00_AXIS_HIGHTDEST {0xffffffff} ] [get_bd_cells applicationRegion/output_switch]
# /middleware/python/tclFileGenerator.py:758
...
# /middleware/python/tclFileGenerator.py:806
connect_bd_intf_net [get_bd_intf_pins applicationRegion/input_switch/M00_AXIS] [get_bd_intf_pins applicationRegion/kern_send_inst_0/in_V]
# /middleware/python/tclFileGenerator.py:806
connect_bd_intf_net [get_bd_intf_pins applicationRegion/input_switch/M01_AXIS] [get_bd_intf_pins applicationRegion/myproject_galapagos_inst_1/in_V]
# /middleware/python/tclFileGenerator.py:820
...
# /middleware/python/tclFileGenerator.py:914
connect_bd_intf_net [get_bd_intf_pins applicationRegion/kern_send_inst_0/out_V] [get_bd_intf_pins applicationRegion/output_switch/S00_AXIS]
# /middleware/python/tclFileGenerator.py:914
connect_bd_intf_net [get_bd_intf_pins applicationRegion/myproject_galapagos_inst_1/out_V] [get_bd_intf_pins applicationRegion/output_switch/S01_AXIS]
# /middleware/python/tclFileGenerator.py:928
connect_bd_intf_net [get_bd_intf_pins applicationRegion/output_switch/M00_AXIS] [get_bd_intf_pins applicationRegion/custom_switch_inst/stream_in_V]
