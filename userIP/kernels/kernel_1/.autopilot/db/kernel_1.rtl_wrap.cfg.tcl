...
set DataType03 "[list ap_uint 16 ]"
...
set DataType0 [list "dataword" "struct dataword" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "dataword" "struct dataword" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
