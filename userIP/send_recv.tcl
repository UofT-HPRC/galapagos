...
connect_bd_intf_net [get_bd_intf_ports RX_AXIS] [get_bd_intf_pins in_fifo/S_AXIS]
...
connect_bd_intf_net [get_bd_intf_ports TX_AXIS] [get_bd_intf_pins out_fifo/M_AXIS]
...
connect_bd_intf_net [get_bd_intf_ports TX_WAN_AXIS] [get_bd_intf_pins out_fifo_wan/M_AXIS]
...
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/S00_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/M00_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/M01_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/M02_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/M03_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/M04_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/M05_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/M06_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_interconnect/M07_ACLK]
connect_bd_net [get_bd_ports CLK] [get_bd_pins receiver/aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins dest_id/s_axi_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_cnt/s_axi_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins run_penalty/s_axi_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins fof_fob/s_axi_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins good_total/s_axi_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins sender/aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins network_throttle/aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins out_fifo/s_axis_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins in_fifo/s_axis_aclk]

connect_bd_net [get_bd_ports CLK] [get_bd_pins dest_id_wan/s_axi_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins user_cnt_wan/s_axi_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins run_penalty_wan/s_axi_aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins sender_wan/aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins network_throttle_wan/aclk]
connect_bd_net [get_bd_ports CLK] [get_bd_pins out_fifo_wan/s_axis_aclk]

connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/M00_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/S00_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/M01_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/M02_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/M03_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/M04_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/M05_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/M06_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_interconnect/M07_ARESETN]
connect_bd_net [get_bd_ports rstn] [get_bd_pins fof_fob/s_axi_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins good_total/s_axi_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins in_fifo/s_axis_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins dest_id/s_axi_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins run_penalty/s_axi_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_cnt/s_axi_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins receiver/aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins sender/aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins network_throttle/aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins out_fifo/s_axis_aresetn]

connect_bd_net [get_bd_ports rstn] [get_bd_pins dest_id_wan/s_axi_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins user_cnt_wan/s_axi_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins run_penalty_wan/s_axi_aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins sender_wan/aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins network_throttle_wan/aresetn]
connect_bd_net [get_bd_ports rstn] [get_bd_pins out_fifo_wan/s_axis_aresetn]
