...
set DataType0 [list "PAYLOAD" "struct PAYLOAD" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "payload_length"
set BitWidth1 "32"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType1 [list "PAYLOADLEN" "struct PAYLOADLEN" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
set Port1 [list $PortName1 $Interface1 $DataType1 $Pointer1 $Dims1 $Const1 $Volatile1 $ArrayOpt1]
lappend PortList $Port1
set PortName2 "payload_out"
set BitWidth2 "1024"
set ArrayOpt2 ""
set Const2 "0"
set Volatile2 "0"
...
set DataType2 [list "PAYLOAD_FULL" "struct PAYLOAD_FULL" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
set Port2 [list $PortName2 $Interface2 $DataType2 $Pointer2 $Dims2 $Const2 $Volatile2 $ArrayOpt2]
lappend PortList $Port2
set PortName3 "checksum"
set BitWidth3 "64"
set ArrayOpt3 ""
set Const3 "0"
set Volatile3 "0"
...
set DataType3 [list "PAYLOAD_CHECKSUM" "struct PAYLOAD_CHECKSUM" $structMem3 1 0 $structParameter3 $structArgument3 $NameSpace3 $structIsPacked3]
