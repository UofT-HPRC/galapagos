...
eval "cg_default_interface_gen_dc { \
    id 12 \
    name packet_out_data_V \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_packet_out_data_V \
    op interface \
    ports { packet_out_data_V { O 512 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 13 \
    name packet_out_keep_V \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_packet_out_keep_V \
    op interface \
    ports { packet_out_keep_V { O 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 14 \
    name packet_out_valid_V \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_packet_out_valid_V \
    op interface \
    ports { packet_out_valid_V { O 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 15 \
    name packet_out_last_V \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_packet_out_last_V \
    op interface \
    ports { packet_out_last_V { O 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 16 \
    name packet_out_ready_V \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_packet_out_ready_V \
    op interface \
    ports { packet_out_ready_V { I 1 vector } } \
} "
}
