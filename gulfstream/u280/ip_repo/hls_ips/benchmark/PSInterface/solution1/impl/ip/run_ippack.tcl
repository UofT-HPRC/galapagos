...
set Library     "hls"
set IPName      "PSInterface"
set Version     "1.0"
set DisplayName "Psinterface"
set Revision    "2113660371"
...
set sdx_kernel_name "PSInterface"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/kevinliu/Documents/gulf_stream/u280/GULF-Stream/ip_repo/hls_ips/benchmark/PSInterface/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {PSInterface_AXILiteS_s_axi
PSInterface
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 axil_start_V W 0x0 "Data signal of axil_start_V" {{0 32 axil_start_V W 0 "Bit 31 to 0 Data signal of axil_start_V"}}} {0x18 axil_pkt_num_V W 0x0 "Data signal of axil_pkt_num_V" {{0 32 axil_pkt_num_V W 0 "Bit 31 to 0 Data signal of axil_pkt_num_V"}}} {0x20 axil_pkt_len_V W 0x0 "Data signal of axil_pkt_len_V" {{0 32 axil_pkt_len_V W 0 "Bit 31 to 0 Data signal of axil_pkt_len_V"}}} {0x28 axil_remote_ip_V W 0x0 "Data signal of axil_remote_ip_V" {{0 32 axil_remote_ip_V W 0 "Bit 31 to 0 Data signal of axil_remote_ip_V"}}} {0x30 axil_remote_port_V W 0x0 "Data signal of axil_remote_port_V" {{0 32 axil_remote_port_V W 0 "Bit 31 to 0 Data signal of axil_remote_port_V"}}} {0x38 axil_local_port_V W 0x0 "Data signal of axil_local_port_V" {{0 32 axil_local_port_V W 0 "Bit 31 to 0 Data signal of axil_local_port_V"}}} {0x40 axil_tx_timeElapse_high_V R 0x0 "Data signal of axil_tx_timeElapse_high_V" {{0 32 axil_tx_timeElapse_high_V R 0 "Bit 31 to 0 Data signal of axil_tx_timeElapse_high_V"}}} {0x44 axil_tx_timeElapse_high_V_ctrl R 0x0 "Control signal of axil_tx_timeElapse_high_V" {{0 1 axil_tx_timeElapse_high_V_ap_vld R 0 "Control signal axil_tx_timeElapse_high_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 axil_tx_timeElapse_low_V R 0x0 "Data signal of axil_tx_timeElapse_low_V" {{0 32 axil_tx_timeElapse_low_V R 0 "Bit 31 to 0 Data signal of axil_tx_timeElapse_low_V"}}} {0x4c axil_tx_timeElapse_low_V_ctrl R 0x0 "Control signal of axil_tx_timeElapse_low_V" {{0 1 axil_tx_timeElapse_low_V_ap_vld R 0 "Control signal axil_tx_timeElapse_low_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 axil_tx_done_V R 0x0 "Data signal of axil_tx_done_V" {{0 32 axil_tx_done_V R 0 "Bit 31 to 0 Data signal of axil_tx_done_V"}}} {0x54 axil_tx_done_V_ctrl R 0x0 "Control signal of axil_tx_done_V" {{0 1 axil_tx_done_V_ap_vld R 0 "Control signal axil_tx_done_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 axil_latency_sum_high_V R 0x0 "Data signal of axil_latency_sum_high_V" {{0 32 axil_latency_sum_high_V R 0 "Bit 31 to 0 Data signal of axil_latency_sum_high_V"}}} {0x5c axil_latency_sum_high_V_ctrl R 0x0 "Control signal of axil_latency_sum_high_V" {{0 1 axil_latency_sum_high_V_ap_vld R 0 "Control signal axil_latency_sum_high_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 axil_latency_sum_low_V R 0x0 "Data signal of axil_latency_sum_low_V" {{0 32 axil_latency_sum_low_V R 0 "Bit 31 to 0 Data signal of axil_latency_sum_low_V"}}} {0x64 axil_latency_sum_low_V_ctrl R 0x0 "Control signal of axil_latency_sum_low_V" {{0 1 axil_latency_sum_low_V_ap_vld R 0 "Control signal axil_latency_sum_low_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 axil_rx_timeElaspe_high_V R 0x0 "Data signal of axil_rx_timeElaspe_high_V" {{0 32 axil_rx_timeElaspe_high_V R 0 "Bit 31 to 0 Data signal of axil_rx_timeElaspe_high_V"}}} {0x6c axil_rx_timeElaspe_high_V_ctrl R 0x0 "Control signal of axil_rx_timeElaspe_high_V" {{0 1 axil_rx_timeElaspe_high_V_ap_vld R 0 "Control signal axil_rx_timeElaspe_high_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 axil_rx_timeElaspe_low_V R 0x0 "Data signal of axil_rx_timeElaspe_low_V" {{0 32 axil_rx_timeElaspe_low_V R 0 "Bit 31 to 0 Data signal of axil_rx_timeElaspe_low_V"}}} {0x74 axil_rx_timeElaspe_low_V_ctrl R 0x0 "Control signal of axil_rx_timeElaspe_low_V" {{0 1 axil_rx_timeElaspe_low_V_ap_vld R 0 "Control signal axil_rx_timeElaspe_low_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 axil_rx_done_V R 0x0 "Data signal of axil_rx_done_V" {{0 32 axil_rx_done_V R 0 "Bit 31 to 0 Data signal of axil_rx_done_V"}}} {0x7c axil_rx_done_V_ctrl R 0x0 "Control signal of axil_rx_done_V" {{0 1 axil_rx_done_V_ap_vld R 0 "Control signal axil_rx_done_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 axil_rx_error_V R 0x0 "Data signal of axil_rx_error_V" {{0 32 axil_rx_error_V R 0 "Bit 31 to 0 Data signal of axil_rx_error_V"}}} {0x84 axil_rx_error_V_ctrl R 0x0 "Control signal of axil_rx_error_V" {{0 1 axil_rx_error_V_ap_vld R 0 "Control signal axil_rx_error_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 axil_rx_curr_cnt_V R 0x0 "Data signal of axil_rx_curr_cnt_V" {{0 32 axil_rx_curr_cnt_V R 0 "Bit 31 to 0 Data signal of axil_rx_curr_cnt_V"}}} {0x8c axil_rx_curr_cnt_V_ctrl R 0x0 "Control signal of axil_rx_curr_cnt_V" {{0 1 axil_rx_curr_cnt_V_ap_vld R 0 "Control signal axil_rx_curr_cnt_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3.103 machine 64 combinational 1 latency 0 II x}
