...
set C_modelName {udp_eth_assemble}
set C_modelType { void 0 }
set C_modelArgList {
	{ myMac_V int 48 regular  }
	{ myIP_V int 32 regular  }
	{ action int 161 regular  }
	...
	{ packet_out_data_V int 512 regular {pointer 1}  }
	{ packet_out_keep_V int 64 regular {pointer 1}  }
	{ packet_out_valid_V int 1 regular {pointer 1}  }
	{ packet_out_last_V int 1 regular {pointer 1}  }
	{ packet_out_ready_V int 1 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "myMac_V", "interface" : "wire", "bitwidth" : 48, "direction" : "READONLY", "bitSlice":[{"low":0,"up":47,"cElement": [{"cName": "myMac.V","cData": "uint48","bit_use": { "low": 0,"up": 47},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "action", "interface" : "wire", "bitwidth" : 161, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "action.dst_ip.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]},{"low":32,"up":79,"cElement": [{"cName": "action.dst_mac.V","cData": "uint48","bit_use": { "low": 0,"up": 47},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]},{"low":80,"up":95,"cElement": [{"cName": "action.src_port.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]},{"low":96,"up":111,"cElement": [{"cName": "action.dst_port.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]},{"low":112,"up":128,"cElement": [{"cName": "action.udp_cksum.V","cData": "uint17","bit_use": { "low": 0,"up": 16},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]},{"low":129,"up":144,"cElement": [{"cName": "action.ip_cksum.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]},{"low":145,"up":160,"cElement": [{"cName": "action.payload_length.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "packet_out_data_V", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":511,"cElement": [{"cName": "packet_out.data.V","cData": "uint512","bit_use": { "low": 0,"up": 511},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "packet_out_keep_V", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "packet_out.keep.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "packet_out_valid_V", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "packet_out.valid.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "packet_out_last_V", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "packet_out.last.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "packet_out_ready_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "packet_out_ready.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} ]}
...
set portList { 
	...
	{ action sc_in sc_lv 161 signal 2 } 
	{ action_valid_V sc_in sc_lv 1 signal 3 } 
	{ action_empty_V sc_in sc_lv 1 signal 4 } 
	{ action_re_V sc_out sc_lv 1 signal 5 } 
	...
	{ payload_ready_V sc_out sc_lv 1 signal 10 } 
	{ packet_out_data_V sc_out sc_lv 512 signal 11 } 
	{ packet_out_keep_V sc_out sc_lv 64 signal 12 } 
	{ packet_out_valid_V sc_out sc_lv 1 signal 13 } 
	{ packet_out_last_V sc_out sc_lv 1 signal 14 } 
	{ packet_out_ready_V sc_in sc_lv 1 signal 15 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "action", "direction": "in", "datatype": "sc_lv", "bitwidth":161, "type": "signal", "bundle":{"name": "action", "role": "default" }} , 
 	...
 	{ "name": "packet_out_data_V", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "packet_out_data_V", "role": "default" }} , 
 	{ "name": "packet_out_keep_V", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "packet_out_keep_V", "role": "default" }} , 
 	{ "name": "packet_out_valid_V", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "packet_out_valid_V", "role": "default" }} , 
 	{ "name": "packet_out_last_V", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "packet_out_last_V", "role": "default" }} , 
 	{ "name": "packet_out_ready_V", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "packet_out_ready_V", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "udp_eth_assemble",
		...
		"Port" : [
			...
			{"Name" : "packet_out_data_V", "Type" : "None", "Direction" : "O"},
			{"Name" : "packet_out_keep_V", "Type" : "None", "Direction" : "O"},
			{"Name" : "packet_out_valid_V", "Type" : "None", "Direction" : "O"},
			{"Name" : "packet_out_last_V", "Type" : "None", "Direction" : "O"},
			{"Name" : "packet_out_ready_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "packet_out_reg_data_s", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "packet_out_reg_keep_s", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "packet_out_reg_valid", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "packet_out_reg_last_s", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "payloadin_pause_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "IN_PACKET_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "myMac_reg_V", "Type" : "OVld", "Direction" : "IO"},
...
set ArgLastReadFirstWriteLatency {
	udp_eth_assemble {
		...
		packet_out_data_V {Type O LastRead -1 FirstWrite 0}
		packet_out_keep_V {Type O LastRead -1 FirstWrite 0}
		packet_out_valid_V {Type O LastRead -1 FirstWrite 0}
		packet_out_last_V {Type O LastRead -1 FirstWrite 0}
		packet_out_ready_V {Type I LastRead 0 FirstWrite -1}
		packet_out_reg_data_s {Type IO LastRead -1 FirstWrite -1}
		packet_out_reg_keep_s {Type IO LastRead -1 FirstWrite -1}
		packet_out_reg_valid {Type IO LastRead -1 FirstWrite -1}
		packet_out_reg_last_s {Type IO LastRead -1 FirstWrite -1}
		payloadin_pause_V {Type IO LastRead -1 FirstWrite -1}
		IN_PACKET_V {Type IO LastRead -1 FirstWrite -1}
		myMac_reg_V {Type IO LastRead -1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	action { ap_none {  { action in_data 0 161 } } }
	...
	packet_out_data_V { ap_none {  { packet_out_data_V out_data 1 512 } } }
	packet_out_keep_V { ap_none {  { packet_out_keep_V out_data 1 64 } } }
	packet_out_valid_V { ap_none {  { packet_out_valid_V out_data 1 1 } } }
	packet_out_last_V { ap_none {  { packet_out_last_V out_data 1 1 } } }
	packet_out_ready_V { ap_none {  { packet_out_ready_V in_data 0 1 } } }
}
