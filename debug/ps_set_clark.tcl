proc getPresetInfo {} {
  set vlnv_version_independent [get_ipdefs -filter {NAME == zynq_ultra_ps_e}]
  return [dict create name {ps_set_sidewinder} description {ps_set_sidewinder}  vlnv $vlnv_version_independent display_name {ps_set_sidewinder} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PSU__CRL_APB__PCAP_CTRL__ACT_FREQMHZ {166.664998}  \
