...
create_clock -period 3.103 [get_ports gt_0_ref_clk_p]
set_property PACKAGE_PIN R33 [get_ports gt_0_ref_clk_n]
set_property PACKAGE_PIN R32 [get_ports gt_0_ref_clk_p]
