...
module tcp_slowrttoe_m_axis_listen_port_rsp_if (
    // AXI4-Stream singals
    input  wire       ACLK,
    input  wire       ARESETN,
    output wire       TVALID,
...
//------------------------Instantiation------------------
// rs
tcp_slowrttoe_m_axis_listen_port_rsp_reg_slice #(
    .N       ( 1 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
tcp_slowrttoe_m_axis_listen_port_rsp_fifo #(
    .DATA_BITS  ( 1 ),
    .DEPTH_BITS ( 4 )
) listenPortRsp_V_fifo (
    .clk        ( ACLK ),
...
module tcp_slowrttoe_m_axis_listen_port_rsp_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module tcp_slowrttoe_m_axis_listen_port_rsp_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
