...
module tcp_slowrttoe_m_axis_tx_data_rsp_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
...
//------------------------Instantiation------------------
// rs
tcp_slowrttoe_m_axis_tx_data_rsp_reg_slice #(
    .N       ( 17 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// txDataRsp_V_V_fifo
tcp_slowrttoe_m_axis_tx_data_rsp_fifo #(
    .DATA_BITS  ( 17 ),
    .DEPTH_BITS ( 4 )
) txDataRsp_V_V_fifo (
    .clk        ( ACLK ),
...
module tcp_slowrttoe_m_axis_tx_data_rsp_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module tcp_slowrttoe_m_axis_tx_data_rsp_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
