...
module tcp_slowrttoe_s_axis_tcp_data_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
...
//------------------------Instantiation------------------
// rs
tcp_slowrttoe_s_axis_tcp_data_reg_slice #(
    .N       ( 73 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
tcp_slowrttoe_s_axis_tcp_data_fifo #(
    .DATA_BITS  ( 64 ),
    .DEPTH_BITS ( 4 )
) ipRxData_V_data_V_fifo (
    .clk        ( ACLK ),
...
module tcp_slowrttoe_s_axis_tcp_data_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module tcp_slowrttoe_s_axis_tcp_data_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
