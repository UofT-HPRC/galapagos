...
module tcp_slowrttoe_m_axis_rx_data_rsp_metadata_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
...
//------------------------Instantiation------------------
// rs
tcp_slowrttoe_m_axis_rx_data_rsp_metadata_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
tcp_slowrttoe_m_axis_rx_data_rsp_metadata_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) rxDataRspMeta_V_V_fifo (
    .clk        ( ACLK ),
...
module tcp_slowrttoe_m_axis_rx_data_rsp_metadata_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module tcp_slowrttoe_m_axis_rx_data_rsp_metadata_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
