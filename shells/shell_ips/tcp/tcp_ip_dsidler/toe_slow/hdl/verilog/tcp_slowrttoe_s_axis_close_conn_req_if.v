...
module tcp_slowrttoe_s_axis_close_conn_req_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
...
//------------------------Instantiation------------------
// rs
tcp_slowrttoe_s_axis_close_conn_req_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
tcp_slowrttoe_s_axis_close_conn_req_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) closeConnReq_V_V_fifo (
    .clk        ( ACLK ),
...
module tcp_slowrttoe_s_axis_close_conn_req_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module tcp_slowrttoe_s_axis_close_conn_req_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
