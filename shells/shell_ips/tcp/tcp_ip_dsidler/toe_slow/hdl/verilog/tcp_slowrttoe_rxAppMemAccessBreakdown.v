...
module tcp_slowrttoe_rxAppMemAccessBreakdown (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] tmp_V_phi_fu_211_p4;
wire    rxAppStreamIf2memAccessBreakdo0_status;
wire   [0:0] tmp_3_nbreadreq_fu_144_p10;
wire   [0:0] grp_nbwritereq_fu_166_p3;
wire   [0:0] tmp_5_fu_287_p2;
reg    ap_sig_bdd_110;
reg    rxAppStreamIf2memAccessBreakdo0_update;
wire   [71:0] tmp_122_fu_293_p9;
wire   [71:0] tmp1_fu_330_p5;
wire   [71:0] tmp_240_fu_399_p5;
wire   [31:0] p_Result_s_fu_353_p5;
wire   [15:0] tmp_7_fu_314_p2;
wire   [15:0] tmp_1_fu_383_p2;
wire   [15:0] tmp_630_fu_269_p1;
wire   [23:0] lhs_V_cast_fu_273_p1;
wire   [23:0] rhs_V_cast_fu_277_p1;
wire   [23:0] r_V_fu_281_p2;
wire   [22:0] tmp_bbt_V_4_fu_326_p1;
wire   [15:0] tmp_629_fu_375_p1;
wire   [22:0] tmp_bbt_V_fu_395_p1;
reg   [0:0] ap_NS_fsm;
reg    ap_sig_bdd_310;
reg    ap_sig_bdd_312;
reg    ap_sig_bdd_309;
...
begin
    if (ap_sig_bdd_309) begin
        if (~(ap_const_lv1_0 == rxAppBreakdown)) begin
            rxAppAccLength_V <= tmp_1_fu_383_p2;
        end else if (ap_sig_bdd_312) begin
            rxAppAccLength_V <= tmp_7_fu_314_p2;
        end
    end
end
...
begin
    if (ap_sig_bdd_309) begin
        if (~(ap_const_lv1_0 == rxAppBreakdown)) begin
            rxAppTempCmd_saddr_V <= p_Result_s_fu_353_p5;
...
always @(posedge ap_clk)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & (ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & ~ap_sig_bdd_110)) begin
...
always @ (rxAppBreakdown or tmp_122_fu_293_p9 or tmp1_fu_330_p5 or tmp_240_fu_399_p5 or ap_sig_bdd_310 or ap_sig_bdd_312 or ap_sig_bdd_309)
begin
    if (ap_sig_bdd_309) begin
        if (~(ap_const_lv1_0 == rxAppBreakdown)) begin
            outputMemAccess_V_din = tmp_240_fu_399_p5;
        end else if (ap_sig_bdd_312) begin
            outputMemAccess_V_din = tmp1_fu_330_p5;
        end else if (ap_sig_bdd_310) begin
            outputMemAccess_V_din = tmp_122_fu_293_p9;
        end else begin
...
always @ (ap_sig_cseq_ST_st1_fsm_0 or rxAppBreakdown or tmp_3_nbreadreq_fu_144_p10 or grp_nbwritereq_fu_166_p3 or tmp_5_fu_287_p2 or ap_sig_bdd_110)
begin
    if ((((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & (ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & (ap_const_lv1_0 == tmp_5_fu_287_p2) & ~ap_sig_bdd_110) | ((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & (ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & ~(ap_const_lv1_0 == tmp_5_fu_287_p2) & ~ap_sig_bdd_110) | ((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & ~(ap_const_lv1_0 == rxAppBreakdown) & ~ap_sig_bdd_110))) begin
...
always @ (ap_sig_cseq_ST_st1_fsm_0 or rxAppBreakdown or tmp_3_nbreadreq_fu_144_p10 or grp_nbwritereq_fu_166_p3 or ap_sig_bdd_110)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & (ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & ~ap_sig_bdd_110)) begin
...
/// tmp_V_phi_fu_211_p4 assign process. ///
always @ (tmp_5_fu_287_p2 or ap_sig_bdd_318)
begin
    if (ap_sig_bdd_318) begin
        if (~(ap_const_lv1_0 == tmp_5_fu_287_p2)) begin
            tmp_V_phi_fu_211_p4 = ap_const_lv1_1;
        end else if ((ap_const_lv1_0 == tmp_5_fu_287_p2)) begin
            tmp_V_phi_fu_211_p4 = ap_const_lv1_0;
        end else begin
            tmp_V_phi_fu_211_p4 = 'bx;
        end
    end else begin
        tmp_V_phi_fu_211_p4 = 'bx;
    end
...
always @ (ap_start or ap_done_reg or outputMemAccess_V_full_n or rxAppBreakdown or rxAppDoubleAccess_V_V_full_n or rxAppStreamIf2memAccessBreakdo0_status or tmp_3_nbreadreq_fu_144_p10 or grp_nbwritereq_fu_166_p3 or tmp_5_fu_287_p2)
begin
    ap_sig_bdd_110 = (((rxAppStreamIf2memAccessBreakdo0_status == ap_const_logic_0) & (ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3)) | ((ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & (outputMemAccess_V_full_n == ap_const_logic_0) & (ap_const_lv1_0 == tmp_5_fu_287_p2)) | ((ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & (outputMemAccess_V_full_n == ap_const_logic_0) & ~(ap_const_lv1_0 == tmp_5_fu_287_p2)) | ((ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & (rxAppDoubleAccess_V_V_full_n == ap_const_logic_0)) | (~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & (outputMemAccess_V_full_n == ap_const_logic_0) & ~(ap_const_lv1_0 == rxAppBreakdown)) | (ap_start == ap_const_logic_0) | (ap_done_reg == ap_const_logic_1));
end
...
always @ (ap_sig_cseq_ST_st1_fsm_0 or grp_nbwritereq_fu_166_p3 or ap_sig_bdd_110)
begin
    ap_sig_bdd_309 = ((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3) & ~ap_sig_bdd_110);
end

/// ap_sig_bdd_310 assign process. ///
always @ (rxAppBreakdown or tmp_3_nbreadreq_fu_144_p10 or tmp_5_fu_287_p2)
begin
    ap_sig_bdd_310 = ((ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & (ap_const_lv1_0 == tmp_5_fu_287_p2));
end

/// ap_sig_bdd_312 assign process. ///
always @ (rxAppBreakdown or tmp_3_nbreadreq_fu_144_p10 or tmp_5_fu_287_p2)
begin
    ap_sig_bdd_312 = ((ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == tmp_5_fu_287_p2));
end

/// ap_sig_bdd_318 assign process. ///
always @ (ap_sig_cseq_ST_st1_fsm_0 or rxAppBreakdown or tmp_3_nbreadreq_fu_144_p10 or grp_nbwritereq_fu_166_p3)
begin
    ap_sig_bdd_318 = ((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & (ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_166_p3));
end

/// ap_sig_bdd_84 assign process. ///
always @ (rxAppBreakdown or tmp_3_nbreadreq_fu_144_p10)
begin
    ap_sig_bdd_84 = ((ap_const_lv1_0 == rxAppBreakdown) & ~(ap_const_lv1_0 == tmp_3_nbreadreq_fu_144_p10));
end
assign grp_nbwritereq_fu_166_p3 = outputMemAccess_V_full_n;
assign lhs_V_cast_fu_273_p1 = tmp_630_fu_269_p1;
assign p_Result_s_fu_353_p5 = {{rxAppTempCmd_saddr_V[32'd31 : 32'd16]}, {ap_const_lv16_0}};
assign r_V_fu_281_p2 = (lhs_V_cast_fu_273_p1 + rhs_V_cast_fu_277_p1);
assign rhs_V_cast_fu_277_p1 = rxAppStreamIf2memAccessBreakdo_dout;
assign rxAppDoubleAccess_V_V_din = tmp_V_phi_fu_211_p4;
...
assign tmp1_fu_330_p5 = {{{{{{ap_const_lv8_0}, {rxAppStreamIf2memAccessBreakdo_5_dout}}}, {ap_const_lv9_181}}}, {tmp_bbt_V_4_fu_326_p1}};
assign tmp_122_fu_293_p9 = {{{{{{{{rxAppStreamIf2memAccessBreakdo_7_dout}, {rxAppStreamIf2memAccessBreakdo_6_dout}}, {rxAppStreamIf2memAccessBreakdo_5_dout}}, {rxAppStreamIf2memAccessBreakdo_4_dout}}, {rxAppStreamIf2memAccessBreakdo_3_dout}}, {rxAppStreamIf2memAccessBreakdo_2_dout}}, {rxAppStreamIf2memAccessBreakdo_1_dout}}, {rxAppStreamIf2memAccessBreakdo_dout}};
assign tmp_1_fu_383_p2 = (tmp_629_fu_375_p1 - rxAppAccLength_V);
assign tmp_240_fu_399_p5 = {{{{{{ap_const_lv8_0}, {p_Result_s_fu_353_p5}}}, {ap_const_lv9_181}}}, {tmp_bbt_V_fu_395_p1}};
assign tmp_3_nbreadreq_fu_144_p10 = (rxAppStreamIf2memAccessBreakdo_empty_n & rxAppStreamIf2memAccessBreakdo_1_empty_n & rxAppStreamIf2memAccessBreakdo_2_empty_n & rxAppStreamIf2memAccessBreakdo_3_empty_n & rxAppStreamIf2memAccessBreakdo_4_empty_n & rxAppStreamIf2memAccessBreakdo_5_empty_n & rxAppStreamIf2memAccessBreakdo_6_empty_n & rxAppStreamIf2memAccessBreakdo_7_empty_n);
assign tmp_5_fu_287_p2 = (r_V_fu_281_p2 > ap_const_lv24_10000? 1'b1: 1'b0);
assign tmp_629_fu_375_p1 = rxAppTempCmd_bbt_V[15:0];
assign tmp_630_fu_269_p1 = rxAppStreamIf2memAccessBreakdo_5_dout[15:0];
assign tmp_7_fu_314_p2 = (ap_const_lv16_0 - tmp_630_fu_269_p1);
assign tmp_bbt_V_4_fu_326_p1 = tmp_7_fu_314_p2;
assign tmp_bbt_V_fu_395_p1 = tmp_1_fu_383_p2;


endmodule //tcp_slowrttoe_rxAppMemAccessBreakdown
