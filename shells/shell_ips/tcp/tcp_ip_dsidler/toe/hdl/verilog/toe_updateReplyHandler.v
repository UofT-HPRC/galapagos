...
wire   [0:0] tmp15_nbreadreq_fu_74_p3;
reg    ap_sig_bdd_49;
wire    slc_sessionInsert_rsp_V_op1_status;
reg   [0:0] tmp15_reg_125;
reg   [0:0] tmp_712_reg_134;
reg    ap_sig_bdd_60;
wire   [0:0] tmp_source_fu_103_p1;
reg   [0:0] tmp_source_reg_129;
reg   [13:0] tmp_sessionID_V_reg_138;
...
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_49) | (ap_sig_bdd_60 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1))))) begin
        tmp15_reg_125 <= tmp15_nbreadreq_fu_74_p3;
    end
end
...
always @(posedge ap_clk)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & ~(tmp15_nbreadreq_fu_74_p3 == ap_const_lv1_0) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_49) | (ap_sig_bdd_60 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1))))) begin
        tmp_712_reg_134 <= sessionUpdate_rsp_V_dout[ap_const_lv32_1];
        tmp_sessionID_V_reg_138 <= {{sessionUpdate_rsp_V_dout[ap_const_lv32_F : ap_const_lv32_2]}};
        tmp_source_reg_129 <= tmp_source_fu_103_p1;
    end
end
...
always @ (ap_done_reg or ap_sig_cseq_ST_pp0_stg0_fsm_0 or ap_reg_ppiten_pp0_it0 or ap_reg_ppiten_pp0_it1 or tmp15_nbreadreq_fu_74_p3 or ap_sig_bdd_49 or ap_sig_bdd_60)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ~(tmp15_nbreadreq_fu_74_p3 == ap_const_lv1_0) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_49) | (ap_sig_bdd_60 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1))))) begin
...
always @ (ap_done_reg or ap_sig_cseq_ST_pp0_stg0_fsm_0 or ap_reg_ppiten_pp0_it0 or ap_reg_ppiten_pp0_it1 or ap_sig_bdd_49 or tmp15_reg_125 or tmp_712_reg_134 or ap_sig_bdd_60)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & ~(ap_const_lv1_0 == tmp15_reg_125) & (ap_const_lv1_0 == tmp_712_reg_134) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_49) | (ap_sig_bdd_60 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1))))) begin
...
always @ (ap_start or ap_done_reg or sessionUpdate_rsp_V_empty_n or tmp15_nbreadreq_fu_74_p3)
begin
    ap_sig_bdd_49 = (((sessionUpdate_rsp_V_empty_n == ap_const_logic_0) & ~(tmp15_nbreadreq_fu_74_p3 == ap_const_lv1_0)) | (ap_start == ap_const_logic_0) | (ap_done_reg == ap_const_logic_1));
end

/// ap_sig_bdd_60 assign process. ///
always @ (slc_sessionInsert_rsp_V_op1_status or tmp15_reg_125 or tmp_712_reg_134)
begin
    ap_sig_bdd_60 = ((slc_sessionInsert_rsp_V_op1_status == ap_const_logic_0) & ~(ap_const_lv1_0 == tmp15_reg_125) & (ap_const_lv1_0 == tmp_712_reg_134));
end
...
assign slc_sessionInsert_rsp_V_sessio_din = tmp_sessionID_V_reg_138;
assign slc_sessionInsert_rsp_V_sessio_write = slc_sessionInsert_rsp_V_op1_update;
assign slc_sessionInsert_rsp_V_source_din = tmp_source_reg_129;
assign slc_sessionInsert_rsp_V_source_write = slc_sessionInsert_rsp_V_op1_update;
assign tmp15_nbreadreq_fu_74_p3 = sessionUpdate_rsp_V_empty_n;
assign tmp_source_fu_103_p1 = sessionUpdate_rsp_V_dout[0:0];
