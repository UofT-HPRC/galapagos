...
(* CORE_GENERATION_INFO="mac_ip_encode,hls_ip_2015_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx690tffg1761-2,HLS_INPUT_CLOCK=6.400000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=13.101000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=20,HLS_SYN_DSP=0,HLS_SYN_FF=1230,HLS_SYN_LUT=1927}" *)
...
wire   [72:0] mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_din;
wire    mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_full_n;
wire    mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_write;
wire   [47:0] mac_ip_encode_handle_arp_reply_U0_myMacAddress_V;
reg    mac_ip_encode_add_padding_U0_ap_start = 1'b0;
wire    mac_ip_encode_add_padding_U0_ap_done;
wire    mac_ip_encode_add_padding_U0_ap_continue;
wire    mac_ip_encode_add_padding_U0_ap_idle;
wire    mac_ip_encode_add_padding_U0_ap_ready;
wire   [63:0] mac_ip_encode_add_padding_U0_dataOut_V_data_V_din;
wire    mac_ip_encode_add_padding_U0_dataOut_V_data_V_full_n;
wire    mac_ip_encode_add_padding_U0_dataOut_V_data_V_write;
wire   [7:0] mac_ip_encode_add_padding_U0_dataOut_V_keep_V_din;
wire    mac_ip_encode_add_padding_U0_dataOut_V_keep_V_full_n;
wire    mac_ip_encode_add_padding_U0_dataOut_V_keep_V_write;
wire   [0:0] mac_ip_encode_add_padding_U0_dataOut_V_last_V_din;
wire    mac_ip_encode_add_padding_U0_dataOut_V_last_V_full_n;
wire    mac_ip_encode_add_padding_U0_dataOut_V_last_V_write;
wire   [72:0] mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_dout;
wire    mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_empty_n;
wire    mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_read;
...
wire    dataStreamBuffer3_V_U_ap_dummy_ce;
wire   [72:0] dataStreamBuffer3_V_din;
wire    dataStreamBuffer3_V_full_n;
wire    dataStreamBuffer3_V_write;
wire   [72:0] dataStreamBuffer3_V_dout;
wire    dataStreamBuffer3_V_empty_n;
wire    dataStreamBuffer3_V_read;
reg    ap_CS;
reg    ap_reg_procdone_mac_ip_encode_extract_ip_address_U0 = 1'b0;
reg    ap_reg_procdone_mac_ip_encode_add_padding_U0 = 1'b0;
reg    ap_sig_hs_done;
...
mac_ip_encode_handle_arp_reply mac_ip_encode_handle_arp_reply_U0(
    ...
    .dataStreamBuffer3_V_din( mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_din ),
    .dataStreamBuffer3_V_full_n( mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_full_n ),
    .dataStreamBuffer3_V_write( mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_write ),
    .myMacAddress_V( mac_ip_encode_handle_arp_reply_U0_myMacAddress_V )
);

mac_ip_encode_add_padding mac_ip_encode_add_padding_U0(
    .ap_clk( ap_clk ),
    .ap_rst( ap_rst ),
    .ap_start( mac_ip_encode_add_padding_U0_ap_start ),
    .ap_done( mac_ip_encode_add_padding_U0_ap_done ),
    .ap_continue( mac_ip_encode_add_padding_U0_ap_continue ),
    .ap_idle( mac_ip_encode_add_padding_U0_ap_idle ),
    .ap_ready( mac_ip_encode_add_padding_U0_ap_ready ),
    .dataOut_V_data_V_din( mac_ip_encode_add_padding_U0_dataOut_V_data_V_din ),
    .dataOut_V_data_V_full_n( mac_ip_encode_add_padding_U0_dataOut_V_data_V_full_n ),
    .dataOut_V_data_V_write( mac_ip_encode_add_padding_U0_dataOut_V_data_V_write ),
    .dataOut_V_keep_V_din( mac_ip_encode_add_padding_U0_dataOut_V_keep_V_din ),
    .dataOut_V_keep_V_full_n( mac_ip_encode_add_padding_U0_dataOut_V_keep_V_full_n ),
    .dataOut_V_keep_V_write( mac_ip_encode_add_padding_U0_dataOut_V_keep_V_write ),
    .dataOut_V_last_V_din( mac_ip_encode_add_padding_U0_dataOut_V_last_V_din ),
    .dataOut_V_last_V_full_n( mac_ip_encode_add_padding_U0_dataOut_V_last_V_full_n ),
    .dataOut_V_last_V_write( mac_ip_encode_add_padding_U0_dataOut_V_last_V_write ),
    .dataStreamBuffer3_V_dout( mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_dout ),
    .dataStreamBuffer3_V_empty_n( mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_empty_n ),
    .dataStreamBuffer3_V_read( mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_read )
);
...
FIFO_mac_ip_encode_dataStreamBuffer3_V dataStreamBuffer3_V_U(
    .clk( ap_clk ),
    .reset( ap_rst ),
    .if_read_ce( dataStreamBuffer3_V_U_ap_dummy_ce ),
    .if_write_ce( dataStreamBuffer3_V_U_ap_dummy_ce ),
    .if_din( dataStreamBuffer3_V_din ),
    .if_full_n( dataStreamBuffer3_V_full_n ),
    .if_write( dataStreamBuffer3_V_write ),
    .if_dout( dataStreamBuffer3_V_dout ),
    .if_empty_n( dataStreamBuffer3_V_empty_n ),
    .if_read( dataStreamBuffer3_V_read )
);



/// ap_reg_procdone_mac_ip_encode_add_padding_U0 assign process. ///
always @ (posedge ap_clk)
begin : ap_ret_ap_reg_procdone_mac_ip_encode_add_padding_U0
    if (ap_rst == 1'b1) begin
        ap_reg_procdone_mac_ip_encode_add_padding_U0 <= ap_const_logic_0;
    end else begin
    end
end
...
/// mac_ip_encode_add_padding_U0_ap_start assign process. ///
always @ (posedge ap_clk)
begin : ap_ret_mac_ip_encode_add_padding_U0_ap_start
    if (ap_rst == 1'b1) begin
        mac_ip_encode_add_padding_U0_ap_start <= ap_const_logic_0;
    end else begin
        mac_ip_encode_add_padding_U0_ap_start <= ap_const_logic_1;
    end
end
...
always @ (ap_reg_procdone_mac_ip_encode_extract_ip_address_U0 or ap_reg_procdone_mac_ip_encode_add_padding_U0)
begin
    if (((ap_const_logic_1 == ap_reg_procdone_mac_ip_encode_extract_ip_address_U0) & (ap_const_logic_1 == ap_reg_procdone_mac_ip_encode_add_padding_U0))) begin
...
assign dataOut_V_data_V_din = mac_ip_encode_add_padding_U0_dataOut_V_data_V_din;
assign dataOut_V_data_V_write = mac_ip_encode_add_padding_U0_dataOut_V_data_V_write;
assign dataOut_V_keep_V_din = mac_ip_encode_add_padding_U0_dataOut_V_keep_V_din;
assign dataOut_V_keep_V_write = mac_ip_encode_add_padding_U0_dataOut_V_keep_V_write;
assign dataOut_V_last_V_din = mac_ip_encode_add_padding_U0_dataOut_V_last_V_din;
assign dataOut_V_last_V_write = mac_ip_encode_add_padding_U0_dataOut_V_last_V_write;
...
assign dataStreamBuffer3_V_U_ap_dummy_ce = ap_const_logic_1;
assign dataStreamBuffer3_V_din = mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_din;
assign dataStreamBuffer3_V_read = mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_read;
assign dataStreamBuffer3_V_write = mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_write;
assign mac_ip_encode_add_padding_U0_ap_continue = ap_const_logic_1;
assign mac_ip_encode_add_padding_U0_dataOut_V_data_V_full_n = dataOut_V_data_V_full_n;
assign mac_ip_encode_add_padding_U0_dataOut_V_keep_V_full_n = dataOut_V_keep_V_full_n;
assign mac_ip_encode_add_padding_U0_dataOut_V_last_V_full_n = dataOut_V_last_V_full_n;
assign mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_dout = dataStreamBuffer3_V_dout;
assign mac_ip_encode_add_padding_U0_dataStreamBuffer3_V_empty_n = dataStreamBuffer3_V_empty_n;
...
assign mac_ip_encode_handle_arp_reply_U0_dataStreamBuffer3_V_full_n = dataStreamBuffer3_V_full_n;
