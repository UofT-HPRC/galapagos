...
input arpSendGrat_TVALID ;
output arpSendGrat_TREADY ;
input [8 - 1:0] arpSendGrat_TDATA ;
...
wire arpSendGrat_TVALID;
wire arpSendGrat_TREADY;
wire [8 - 1:0] arpSendGrat_TDATA;
...
wire [8 - 1:0] sig_arp_server_arpSendGrat_V_V_dout;
wire sig_arp_server_arpSendGrat_V_V_empty_n;
wire sig_arp_server_arpSendGrat_V_V_read;
...
arp_server arp_server_U(
    ...
    .arpSendGrat_V_V_dout(sig_arp_server_arpSendGrat_V_V_dout),
    .arpSendGrat_V_V_empty_n(sig_arp_server_arpSendGrat_V_V_empty_n),
    .arpSendGrat_V_V_read(sig_arp_server_arpSendGrat_V_V_read),
...
arp_server_arpSendGrat_if arp_server_arpSendGrat_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .arpSendGrat_V_V_dout(sig_arp_server_arpSendGrat_V_V_dout),
    .arpSendGrat_V_V_empty_n(sig_arp_server_arpSendGrat_V_V_empty_n),
    .arpSendGrat_V_V_read(sig_arp_server_arpSendGrat_V_V_read),
    .TVALID(arpSendGrat_TVALID),
    .TREADY(arpSendGrat_TREADY),
    .TDATA(arpSendGrat_TDATA));
