...
if {[info exists HUNDREDG]} {
    ...
    set_property -dict [list CONFIG.NUM_WRITE_OUTSTANDING {2} CONFIG.NUM_READ_OUTSTANDING {2} CONFIG.FREQ_HZ {199498000} CONFIG.DATA_WIDTH {512}] [get_bd_intf_ports S_AXI_MEM_0]
    set_property -dict [list CONFIG.NUM_WRITE_OUTSTANDING {2} CONFIG.NUM_READ_OUTSTANDING {2} CONFIG.FREQ_HZ {199498000} CONFIG.DATA_WIDTH {512}] [get_bd_intf_ports S_AXI_MEM_1]
