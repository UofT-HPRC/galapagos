...
//#pragma HLS latency min=2 max=2
		...
		struct OutputDataReOrder {
			...
			void digitReversal2Phase(hls::stream<super_sample_container<tp_R,tt_dtype> > &inDatac, tt_dtype2 outDatac[tp_R][tp_L/tp_R]);
		};
		...
		template <int tp_L, int tp_R,typename tt_dtype, typename tt_dtype2>
		//void digitReversal2Phase(tt_dtype inDatac[tp_R][tp_L/tp_R], tt_dtype2 outDatac[tp_R][tp_L/tp_R]);
		void OutputDataReOrder<skew>::digitReversal2Phase(hls::stream<super_sample_container<tp_R,tt_dtype> > &inDatac, tt_dtype2 outDatac[tp_R][tp_L/tp_R])
		{
		#pragma HLS INLINE

			 ///////////////////additions to adding a reshaping module.
			tt_dtype inDatac_reshaped[tp_R][tp_L/tp_R];
...
#pragma HLS ARRAY_RESHAPE variable=inDatac_reshaped complete dim=1
			//streamJoinUtility<tp_L,tp_R,tt_dtype>(inDatac,inDatac_reshaped);
			streamJoinUtility_s2s<tp_L,tp_R,tt_dtype>(inDatac,inDatac_reshaped);
...
//std::cout<<"Using NEW STREAMING JOIN UTILITY.................................\N";
		...
		#pragma HLS DATA_PACK variable=pingPongBuff
			...
			crissCrossAndTimeDigitSwap<tp_L,tp_R>(inDatac_reshaped, pingPongBuff);
		...
		void OutputDataReOrder<0>::digitReversal2Phase(hls::stream<super_sample_container<tp_R,tt_dtype> > &inDatac, tt_dtype2 outDatac[tp_R][tp_L/tp_R])
		{
		#pragma HLS INLINE
		//#pragma HLS DATAFLOW
...
#pragma HLS DATA_PACK variable=pingPongBuff
			...
			///////////////////////////////////// Shuffle the Data and Write to Buffer ////////////////////////////////////
			 //// %%%%%%%%%%%%%%%%% recursivelyProcess:1:Create a Process for buffering streaming data in digit swapped order also do the criss cross from different memories %%%%%%%%%%%%%%
			crissCrossAndTimeDigitSwap_specialization<tp_L,tp_R>(inDatac_reshaped, pingPongBuff);
