...
create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect network/axi_interconnect_tcp_mem
set_property -dict [list CONFIG.NUM_SI {1}] [get_bd_cells network/axi_interconnect_tcp_mem]
