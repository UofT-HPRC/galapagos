...
addip axis_register_slice network/DIRS_NBU
...
connect_bd_intf_net [get_bd_intf_pins network/direct_ip_rx_switch/M00_AXIS] [get_bd_intf_pins network/DIRS_NBU/S_AXIS]
connect_bd_intf_net [get_bd_intf_pins network/DIRS_NBU/M_AXIS] [get_bd_intf_pins network/network_bridge_udp/lbRxDataIn]
...
connect_bd_net [get_bd_ports CLK300] [get_bd_pins network/DIRS_NBU/aclk]
connect_bd_net [get_bd_ports CLK300] [get_bd_pins network/NBU_DIS/aclk]

connect_bd_net [get_bd_ports rstn300] [get_bd_pins network/DIRS_NBU/aresetn]
...
connect_bd_intf_net [get_bd_intf_pins network/network_bridge_inst/axis_data_fifo_0/M_AXIS] [get_bd_intf_pins network/network_bridge_udp/rxGalapagosBridge]
...
#connect_bd_intf_net [get_bd_intf_pins network/network_bridge_inst/axis_data_fifo_0_1/M_AXIS] [get_bd_intf_pins network/network_bridge_udp/rxGalapagosBridge]
...
connect_bd_intf_net [get_bd_intf_pins network/network_bridge_inst/axis_data_fifo_1/S_AXIS] [get_bd_intf_pins network/network_bridge_udp/txGalapagosBridge]
