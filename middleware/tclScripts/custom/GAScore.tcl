...
delete_bd_objs [get_bd_intf_nets applicationRegion/hls_kernel_inst_1_out_r]
connect_bd_intf_net [get_bd_intf_pins applicationRegion/hls_kernel_inst_1/out_r] [get_bd_intf_pins applicationRegion/GAScore_0/kernel_in]
...
# hook up memory
delete_bd_objs [get_bd_intf_nets applicationRegion/hls_kernel_inst_1_m_axi_handler_ctrl]
delete_bd_objs [get_bd_intf_nets applicationRegion/hls_kernel_inst_1_m_axi_local_mem]
delete_bd_objs [get_bd_addr_segs S_AXI_CONTROL/SEG_axi_vip_ctrl_Reg]
delete_bd_objs [get_bd_addr_segs applicationRegion/hls_kernel_inst_1/Data_m_axi_handler_ctrl/SEG_S_AXI_MEM_0_Reg]
delete_bd_objs [get_bd_addr_segs applicationRegion/hls_kernel_inst_1/Data_m_axi_local_mem/SEG_S_AXI_MEM_0_Reg]
...
connect_bd_net [get_bd_pins applicationRegion/xlconstant_0/dout] [get_bd_pins applicationRegion/hls_kernel_inst_1/id]
...
connect_bd_intf_net [get_bd_intf_pins applicationRegion/hls_kernel_inst_1/m_axi_axi_timer] -boundary_type upper [get_bd_intf_pins applicationRegion/axi_interconnect_0/S00_AXI]
...
include_bd_addr_seg [get_bd_addr_segs -excluded applicationRegion/hls_kernel_inst_1/Data_m_axi_axi_timer/SEG_axi_timer_0_Reg]
set_property offset 0x00000000 [get_bd_addr_segs {applicationRegion/hls_kernel_inst_1/Data_m_axi_axi_timer/SEG_axi_timer_0_Reg}]
