set kernel_name benchmark_inst_2
...
# disconnect connection input_switch to kernel and connect to GAScore/net_in
...
delete_bd_objs [get_bd_intf_nets applicationRegion/input_switch_M00_AXIS]
connect_bd_intf_net [get_bd_intf_pins applicationRegion/input_switch/M00_AXIS] [get_bd_intf_pins applicationRegion/GAScore_0/net_in]
...
connect_bd_intf_net [get_bd_intf_pins applicationRegion/GAScore_0/kernel_out] [get_bd_intf_pins applicationRegion/${kernel_name}/in_r]

# disconnect out_r from kernel -> router, connect to kernel_in
delete_bd_objs [get_bd_intf_nets applicationRegion/${kernel_name}_out_r]
connect_bd_intf_net [get_bd_intf_pins applicationRegion/${kernel_name}/out_r] [get_bd_intf_pins applicationRegion/GAScore_0/kernel_in]

# connect GAScore net_out to the input custom switch
...
connect_bd_intf_net [get_bd_intf_pins applicationRegion/GAScore_0/net_out] [get_bd_intf_pins applicationRegion/custom_switch_inst/stream_in]
...
# hook up memory
delete_bd_objs [get_bd_intf_nets applicationRegion/${kernel_name}_m_axi_handler_ctrl]
delete_bd_objs [get_bd_intf_nets applicationRegion/${kernel_name}_m_axi_local_mem]
delete_bd_objs [get_bd_addr_segs S_AXI_CONTROL/SEG_axi_vip_ctrl_Reg]
delete_bd_objs [get_bd_addr_segs applicationRegion/${kernel_name}/Data_m_axi_handler_ctrl/SEG_S_AXI_MEM_0_Reg]
delete_bd_objs [get_bd_addr_segs applicationRegion/${kernel_name}/Data_m_axi_local_mem/SEG_S_AXI_MEM_0_Reg]
...
connect_bd_intf_net [get_bd_intf_pins applicationRegion/GAScore_0/axi_remote] -boundary_type upper [get_bd_intf_pins applicationRegion/axi_interconnect_mem/S00_AXI]
...
set_property -dict [list CONFIG.NUM_SI {1} CONFIG.NUM_MI {1}] [get_bd_cells applicationRegion/axi_interconnect_mem]
...
connect_bd_net [get_bd_pins applicationRegion/xlconstant_0/dout] [get_bd_pins applicationRegion/${kernel_name}/id]
...
connect_bd_intf_net [get_bd_intf_pins applicationRegion/${kernel_name}/m_axi_axi_timer] -boundary_type upper [get_bd_intf_pins applicationRegion/axi_interconnect_0/S00_AXI]
...
include_bd_addr_seg [get_bd_addr_segs -excluded applicationRegion/${kernel_name}/Data_m_axi_axi_timer/SEG_axi_timer_0_Reg]
set_property offset 0x00000000 [get_bd_addr_segs applicationRegion/${kernel_name}/Data_m_axi_axi_timer/SEG_axi_timer_0_Reg]
...
connect_bd_intf_net [get_bd_intf_pins applicationRegion/axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins applicationRegion/${kernel_name}/m_axi_instr_mem]
...
set_property offset 0x00000000 [get_bd_addr_segs applicationRegion/${kernel_name}/Data_m_axi_instr_mem/SEG_axi_bram_ctrl_0_Mem0]
set_property range 4K [get_bd_addr_segs applicationRegion/${kernel_name}/Data_m_axi_instr_mem/SEG_axi_bram_ctrl_0_Mem0]
...
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x00000000} CONFIG.M00_AXIS_HIGHTDEST {0xFFFFFFFF}] [get_bd_cells applicationRegion/input_switch]
