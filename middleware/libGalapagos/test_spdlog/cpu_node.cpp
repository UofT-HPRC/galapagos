...
int main(int argc, char** argv){
    std::string cpu_ip_address = "10.1.2.110";
    ...
    kern_info.push_back(cpu_ip_address);

#if LOG_LEVEL > 0
    std::shared_ptr<spdlog::logger> my_logger = spdlog::basic_logger_mt("basic_logger", "test.log");
#endif
