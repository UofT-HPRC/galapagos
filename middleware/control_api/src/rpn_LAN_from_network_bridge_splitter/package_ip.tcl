...
ipx::associate_bus_interfaces -busif to_rpn_LAN_seq_num_initializer -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rpn_LAN_TX -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rpn_LAN_RX -clock i_clk [ipx::current_core]
