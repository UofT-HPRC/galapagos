...
ipx::associate_bus_interfaces -busif to_rpn_LAN -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rpn_WAN -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rpn_WNN -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rpn_KIP -clock i_clk [ipx::current_core]
