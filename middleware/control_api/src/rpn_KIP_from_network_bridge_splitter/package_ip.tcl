...
ipx::associate_bus_interfaces -busif to_rpn_KIP_TX -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rpn_KIP_RX -clock i_clk [ipx::current_core]
