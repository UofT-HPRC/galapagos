...
HD_PWD='/home/justin/controlapi/galapagos_network_bridge/galapagos/middleware/control_api/src/rpn_LAN_sequence_number_initializer/deployment_LAN_seq_num_initializer/deployment_LAN_seq_num_initializer.runs/design_1_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
