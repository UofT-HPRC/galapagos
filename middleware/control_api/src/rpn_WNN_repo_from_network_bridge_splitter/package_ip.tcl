...
ipx::associate_bus_interfaces -busif to_rpn_WNN_outgoing_repo -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rpn_WNN_incoming_repo -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rpn_WAN_seq_num_initializer -clock i_clk [ipx::current_core]
