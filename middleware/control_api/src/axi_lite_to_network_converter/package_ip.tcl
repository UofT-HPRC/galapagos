...
ipx::associate_bus_interfaces -busif to_WAN -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif S_AXIL -clock i_clk [ipx::current_core]
...
ipgui::add_param -name {BUSY_RESPONSE_PAUSE_DURATION} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core] ]
