...
ipx::associate_bus_interfaces -busif to_rel_outbound -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rel_inbound -clock i_clk [ipx::current_core]
