...
ipx::associate_bus_interfaces -busif from_kernels -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_gs -clock i_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_rx_nb -clock i_clk [ipx::current_core]
...
set_property previous_version_for_upgrade user.org:user:KIP_router:1.0 [ipx::current_core]
