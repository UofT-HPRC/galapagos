...
set src_path_root $galapagos_path/middleware/old_hls/WAN_bin_door
...
add_files $src_path_root/src/WAN_bin_door.cpp -cflags "-I $src_path_root/include -I $galapagos_path/middleware/include_old_hls"
