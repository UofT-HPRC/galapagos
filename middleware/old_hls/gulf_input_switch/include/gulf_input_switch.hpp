...
void CRIP_GULFStream_input_switch(
    gulfstream_interface & in_fetch,
    ap_uint<32> * in_fetch_ip,
    gulfstream_interface & in_network_bridge,
    ap_uint<32> * in_network_bridge_ip,
