...
#pragma HLS resource core=AXI4Stream variable = from_fast_fetch
#pragma HLS resource core=AXI4Stream variable = update
#pragma HLS resource core=AXI4Stream variable = in_network
#pragma HLS resource core=AXI4Stream variable = out_network
#pragma HLS DATA_PACK variable=from_fast_fetch
#pragma HLS DATA_PACK variable=update
#pragma HLS DATA_PACK variable=in_network
#pragma HLS DATA_PACK variable=out_network
