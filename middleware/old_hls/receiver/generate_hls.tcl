...
set src_path_root $galapagos_path/middleware/old_hls/receiver
...
add_files $src_path_root/src/receiver.cpp -cflags "-I $src_path_root/include -I $galapagos_path/middleware/include_old_hls"
