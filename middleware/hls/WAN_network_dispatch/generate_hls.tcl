...
set src_path_root $galapagos_path/middleware/hls/WAN_network_dispatch
...
if {$interface_bandwidth == "100G"} {
    add_files $src_path_root/src/WAN_network_dispatch.cpp -cflags "-I $src_path_root/include -I $galapagos_path/middleware/include -DINTERFACE_100G"
} else {
    add_files $src_path_root/src/WAN_network_dispatch.cpp -cflags "-I $src_path_root/include -I $galapagos_path/middleware/include "
}
