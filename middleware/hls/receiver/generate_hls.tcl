...
set src_path_root $galapagos_path/middleware/hls/receiver
...
if {$interface_bandwidth == "100G"} {
    add_files $src_path_root/src/receiver.cpp -cflags "-I $src_path_root/include -I $galapagos_path/middleware/include -DINTERFACE_100G"
} else {
    add_files $src_path_root/src/receiver.cpp -cflags "-I $src_path_root/include -I $galapagos_path/middleware/include "
}
