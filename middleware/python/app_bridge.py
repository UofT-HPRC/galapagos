...
class appBridge(abstractDict):
    def __init__(self, **kwargs):
        ...
        optional_array = ('vendor', 'lib', 'version', 'type', 'wan','wan_enabled','wan_name','s_axis', 'm_axis', 's_axi', 'm_axi', 'wire_master', 'wire_slave', 'const', 'properties', 'control', 'control_range')
