...
{
    std::string node_ip_address = "10.1.24.132"; // IP Address of the CPU/Software kernels

    // EDIT THESE TO FIT YOUR REQUIREMENTS
    std::string dS_ip = node_ip_address;   // SW Kernel (dS = data_sender)
    std::string mA_ip = "10.1.24.102";     // HW Kernel (mA = multiplierA)
    std::string mB_ip = "10.1.24.103";     // HW Kernel (mB = multiplierB)
