...
port (
    ...
    observedAddress_out_V : OUT STD_LOGIC_VECTOR (47 downto 0);
    ...
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    observedAddress_out_V_ap_vld : OUT STD_LOGIC );
end;
...
architecture behav of ethernet_bridge is 
    ...
    "ethernet_bridge,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku115-flva1517-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.330200,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=461,HLS_SYN_LUT=407}";
    ...
    signal eth_to_app_U0_observedAddress_out_s : STD_LOGIC_VECTOR (47 downto 0);
    signal eth_to_app_U0_observedAddress_out_s_ap_vld : STD_LOGIC;
...
begin
    ...
    port map (
        ...
        observedAddress_out_s => eth_to_app_U0_observedAddress_out_s,
        observedAddress_out_s_ap_vld => eth_to_app_U0_observedAddress_out_s_ap_vld);
    ...
    observedAddress_out_V <= eth_to_app_U0_observedAddress_out_s;
    observedAddress_out_V_ap_vld <= eth_to_app_U0_observedAddress_out_s_ap_vld;
    to_app_V_din <= eth_to_app_U0_to_app_V_din;
    to_app_V_write <= eth_to_app_U0_to_app_V_write;
    to_eth_V_din <= app_to_eth_U0_to_eth_V_din;
    to_eth_V_write <= app_to_eth_U0_to_eth_V_write;
