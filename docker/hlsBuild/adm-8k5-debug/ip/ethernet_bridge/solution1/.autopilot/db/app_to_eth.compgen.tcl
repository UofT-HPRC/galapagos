...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { mac_table_V_address0 { O 8 vector } mac_table_V_ce0 { O 1 bit } mac_table_V_q0 { I 48 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 10 \
    name src_mac_address_V \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_src_mac_address_V \
    op interface \
    ports { src_mac_address_V_dout { I 48 vector } src_mac_address_V_empty_n { I 1 bit } src_mac_address_V_read { O 1 bit } } \
} "
}
