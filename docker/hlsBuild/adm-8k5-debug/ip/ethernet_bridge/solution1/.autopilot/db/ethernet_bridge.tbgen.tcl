set C_TypeInfoList {{ 
"ethernet_bridge" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"to_app": [[], {"reference": "0"}] }, {"from_eth": [[], {"reference": "1"}] }, {"from_app": [[], {"reference": "0"}] }, {"to_eth": [[], {"reference": "1"}] }, {"mac_addr": [["const"],"2"] }, {"observedAddress_out": [[],{ "pointer": "3"}] }],["4"],""],
 "4": [ "mac_table", [[], {"array": ["3", [256]]}],""], 
...
"3": [ "ap_uint<48>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 48}}]],""]}}], 
...
set C_modelArgList {
	...
	{ observedAddress_out_V int 48 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "to_app_V", "interface" : "fifo", "bitwidth" : 81, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "to_app.V.data.V","cData": "int64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]},{"low":64,"up":64,"cElement": [{"cName": "to_app.V.last.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]},{"low":65,"up":72,"cElement": [{"cName": "to_app.V.tdest.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]},{"low":73,"up":80,"cElement": [{"cName": "to_app.V.tkeep.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "observedAddress_out_V", "interface" : "wire", "bitwidth" : 48, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":47,"cElement": [{"cName": "observedAddress_out.V","cData": "uint48","bit_use": { "low": 0,"up": 47},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ observedAddress_out_V sc_out sc_lv 48 signal 5 } 
	{ mac_table_V_address0 sc_out sc_lv 8 signal 6 } 
	{ mac_table_V_ce0 sc_out sc_logic 1 signal 6 } 
	{ mac_table_V_d0 sc_out sc_lv 48 signal 6 } 
	{ mac_table_V_q0 sc_in sc_lv 48 signal 6 } 
	{ mac_table_V_we0 sc_out sc_logic 1 signal 6 } 
	{ mac_table_V_address1 sc_out sc_lv 8 signal 6 } 
	{ mac_table_V_ce1 sc_out sc_logic 1 signal 6 } 
	{ mac_table_V_d1 sc_out sc_lv 48 signal 6 } 
	{ mac_table_V_q1 sc_in sc_lv 48 signal 6 } 
	{ mac_table_V_we1 sc_out sc_logic 1 signal 6 } 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst sc_in sc_logic 1 reset -1 active_high_sync } 
	{ observedAddress_out_V_ap_vld sc_out sc_logic 1 outvld 5 } 
}
set NewPortList {[ 
	{ "name": "to_app_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":81, "type": "signal", "bundle":{"name": "to_app_V", "role": "din" }} , 
 	...
 	{ "name": "observedAddress_out_V", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "observedAddress_out_V", "role": "default" }} , 
 	...
 	{ "name": "observedAddress_out_V_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "observedAddress_out_V", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "observedAddress_out_V", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "eth_to_app_U0", "Port" : "observedAddress_out_s"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.eth_to_app_U0", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "observedAddress_out_s", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "state_V_1", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "dest_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "app_packet_out_last_s", "Type" : "OVld", "Direction" : "IO"}]},
...
set ArgLastReadFirstWriteLatency {
	ethernet_bridge {
		...
		observedAddress_out_V {Type O LastRead -1 FirstWrite 1}
	...
	eth_to_app {
		...
		observedAddress_out_s {Type O LastRead -1 FirstWrite 1}
		state_V_1 {Type IO LastRead -1 FirstWrite -1}
		dest_V {Type IO LastRead -1 FirstWrite -1}
		app_packet_out_last_s {Type IO LastRead -1 FirstWrite -1}}
	app_to_eth {
...
set Spec2ImplPortList { 
	...
	observedAddress_out_V { ap_vld {  { observedAddress_out_V out_data 1 48 }  { observedAddress_out_V_ap_vld out_vld 1 1 } } }
