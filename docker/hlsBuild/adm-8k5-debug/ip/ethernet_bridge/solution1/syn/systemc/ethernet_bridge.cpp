...
ethernet_bridge::ethernet_bridge(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    eth_to_app_U0->observedAddress_out_s(eth_to_app_U0_observedAddress_out_s);
    eth_to_app_U0->observedAddress_out_s_ap_vld(eth_to_app_U0_observedAddress_out_s_ap_vld);
    ...
    SC_METHOD(thread_observedAddress_out_V);
    sensitive << ( eth_to_app_U0_observedAddress_out_s );

    SC_METHOD(thread_observedAddress_out_V_ap_vld);
    sensitive << ( eth_to_app_U0_observedAddress_out_s_ap_vld );
    ...
    sc_trace(mVcdFile, observedAddress_out_V_ap_vld, "(port)observedAddress_out_V_ap_vld");
#endif
    ...
    sc_trace(mVcdFile, eth_to_app_U0_observedAddress_out_s, "eth_to_app_U0_observedAddress_out_s");
    sc_trace(mVcdFile, eth_to_app_U0_observedAddress_out_s_ap_vld, "eth_to_app_U0_observedAddress_out_s_ap_vld");
...
void ethernet_bridge::thread_observedAddress_out_V() {
    observedAddress_out_V = eth_to_app_U0_observedAddress_out_s.read();
}

void ethernet_bridge::thread_observedAddress_out_V_ap_vld() {
    observedAddress_out_V_ap_vld = eth_to_app_U0_observedAddress_out_s_ap_vld.read();
}
...
void ethernet_bridge::thread_hdltv_gen() {
    ...
    while (1) {
        ...
        mHdltvoutHandle << " , " <<  " \"observedAddress_out_V\" :  \"" << observedAddress_out_V.read() << "\" ";
        ...
        mHdltvoutHandle << " , " <<  " \"observedAddress_out_V_ap_vld\" :  \"" << observedAddress_out_V_ap_vld.read() << "\" ";
