...
struct ethernet_bridge : public sc_module {
    ...
    sc_out< sc_lv<48> > observedAddress_out_V;
    ...
    sc_out< sc_logic > observedAddress_out_V_ap_vld;
    ...
    sc_signal< sc_lv<48> > eth_to_app_U0_observedAddress_out_s;
    sc_signal< sc_logic > eth_to_app_U0_observedAddress_out_s_ap_vld;
    ...
    void thread_observedAddress_out_V();
    void thread_observedAddress_out_V_ap_vld();
