...
(* CORE_GENERATION_INFO="ethernet_bridge,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku115-flva1517-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.330200,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=461,HLS_SYN_LUT=407}" *)
...
output  [47:0] observedAddress_out_V;
...
input   ap_clk;
input   ap_rst;
output   observedAddress_out_V_ap_vld;
...
wire   [47:0] eth_to_app_U0_observedAddress_out_s;
wire    eth_to_app_U0_observedAddress_out_s_ap_vld;
...
assign observedAddress_out_V = eth_to_app_U0_observedAddress_out_s;

assign observedAddress_out_V_ap_vld = eth_to_app_U0_observedAddress_out_s_ap_vld;
