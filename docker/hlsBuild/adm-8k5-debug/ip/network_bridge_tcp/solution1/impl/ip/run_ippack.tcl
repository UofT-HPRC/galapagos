...
set Library     "hls"
set IPName      "network_bridge_tcp"
set Version     "1.0"
set DisplayName "Network_bridge_tcp"
set Revision    "2008120041"
...
## Variables
set Top "network_bridge_tcp_top"
...
set Interfaces {
    ...
    m_axis_listen_port {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_listen_port"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    m_axis_open_connection {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_open_connection"
        has_tready "1"
        ports {
            TDATA 48
        }
    ...
    m_axis_read_package {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_read_package"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    m_axis_txGalapagosBridge {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_txGalapagosBridge"
        has_tready "1"
        ports {
            TDATA 64
            TKEEP 8
    ...
    m_axis_tx_metadata {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tx_metadata"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_listen_port_status {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_listen_port_status"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    s_axis_notifications {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_notifications"
        has_tready "1"
        ports {
            TDATA 88
        }
    ...
    s_axis_open_status {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_open_status"
        has_tready "1"
        ports {
            TDATA 24
        }
    ...
    s_axis_rxGalapagosBridge {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rxGalapagosBridge"
        has_tready "1"
        ports {
            TDATA 64
            TKEEP 8
    ...
    s_axis_rx_metadata {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rx_metadata"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    aclk {
        type "clock"
        buses "m_axis_listen_port m_axis_open_connection m_axis_read_package m_axis_txGalapagosBridge m_axis_tx_data m_axis_tx_metadata s_axis_listen_port_status s_axis_notifications s_axis_open_status s_axis_rxGalapagosBridge s_axis_rx_data s_axis_rx_metadata s_axis_tx_status"
    }
    aresetn {
        type "reset"
    }
