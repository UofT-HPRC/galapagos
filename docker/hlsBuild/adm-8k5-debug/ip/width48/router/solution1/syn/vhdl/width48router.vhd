...
entity width48router is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    network_table_V_address0 : OUT STD_LOGIC_VECTOR (7 downto 0);
    network_table_V_ce0 : OUT STD_LOGIC;
    network_table_V_q0 : IN STD_LOGIC_VECTOR (47 downto 0);
    network_addr_V : IN STD_LOGIC_VECTOR (47 downto 0);
    stream_in_V_dout : IN STD_LOGIC_VECTOR (88 downto 0);
    stream_in_V_empty_n : IN STD_LOGIC;
    stream_in_V_read : OUT STD_LOGIC;
    stream_out_switch_V_din : OUT STD_LOGIC_VECTOR (88 downto 0);
    stream_out_switch_V_full_n : IN STD_LOGIC;
    stream_out_switch_V_write : OUT STD_LOGIC;
    stream_out_network_V_din : OUT STD_LOGIC_VECTOR (88 downto 0);
    stream_out_network_V_full_n : IN STD_LOGIC;
    stream_out_network_V_write : OUT STD_LOGIC );
end;


architecture behav of width48router is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "width48router,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku115-flva1517-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=3.159200,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=232,HLS_SYN_LUT=63}";
    ...
    signal network_addr_V_read_reg_122 : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal tmp26_reg_131 : STD_LOGIC_VECTOR (88 downto 0);
    signal tmp26_reg_131_pp0_iter1_reg : STD_LOGIC_VECTOR (88 downto 0);
    ...
    signal tmp_dest_V_fu_102_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                network_addr_V_read_reg_122 <= network_addr_V;
                tmp26_reg_131_pp0_iter1_reg <= tmp26_reg_131;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_nbreadreq_fu_62_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp26_reg_131 <= stream_in_V_dout;
            end if;
        end if;
    end process;
    ...
    inFPGA_fu_117_p2 <= "1" when (network_table_V_q0 = network_addr_V_read_reg_122) else "0";
    network_table_V_address0 <= tmp_2_fu_112_p1(8 - 1 downto 0);

    network_table_V_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001)
    begin
    ...
    stream_out_network_V_din <= tmp26_reg_131_pp0_iter1_reg;
    ...
    stream_out_switch_V_din <= tmp26_reg_131_pp0_iter1_reg;
    ...
    tmp_2_fu_112_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_dest_V_fu_102_p4),64));
    tmp_dest_V_fu_102_p4 <= stream_in_V_dout(71 downto 64);
