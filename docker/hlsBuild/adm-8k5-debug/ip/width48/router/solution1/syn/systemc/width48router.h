...
#ifndef _width48router_HH_
#define _width48router_HH_
...
struct width48router : public sc_module {
    // Port declarations 15
    sc_in_clk ap_clk;
    sc_in< sc_logic > ap_rst;
    sc_out< sc_lv<8> > network_table_V_address0;
    sc_out< sc_logic > network_table_V_ce0;
    sc_in< sc_lv<48> > network_table_V_q0;
    sc_in< sc_lv<48> > network_addr_V;
    ...
    // Module declarations
    width48router(sc_module_name name);
    SC_HAS_PROCESS(width48router);
    ...
    sc_signal< sc_lv<48> > network_addr_V_read_reg_122;
