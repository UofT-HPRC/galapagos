...
output [8 - 1:0] network_table_V_WEN_A ;
output [32 - 1:0] network_table_V_Addr_A ;
output [64 - 1:0] network_table_V_Dout_A ;
input [64 - 1:0] network_table_V_Din_A ;
...
input [48 - 1:0] network_addr_V ;


wire network_table_V_Clk_A;
wire network_table_V_Rst_A;
wire network_table_V_EN_A;
wire [8 - 1:0] network_table_V_WEN_A;
wire [32 - 1:0] network_table_V_Addr_A;
wire [64 - 1:0] network_table_V_Dout_A;
wire [64 - 1:0] network_table_V_Din_A;
...
wire [8 - 1:0] sig_width48router_network_table_V_address0;
wire sig_width48router_network_table_V_ce0;
wire [48 - 1:0] sig_width48router_network_table_V_q0;

wire [89 - 1:0] sig_width48router_stream_in_V_dout;
wire sig_width48router_stream_in_V_empty_n;
wire sig_width48router_stream_in_V_read;

wire [89 - 1:0] sig_width48router_stream_out_network_V_din;
wire sig_width48router_stream_out_network_V_full_n;
wire sig_width48router_stream_out_network_V_write;

wire [89 - 1:0] sig_width48router_stream_out_switch_V_din;
wire sig_width48router_stream_out_switch_V_full_n;
wire sig_width48router_stream_out_switch_V_write;

wire sig_width48router_ap_rst;



width48router width48router_U(
    .network_table_V_address0(sig_width48router_network_table_V_address0),
    .network_table_V_ce0(sig_width48router_network_table_V_ce0),
    .network_table_V_q0(sig_width48router_network_table_V_q0),
    .stream_in_V_dout(sig_width48router_stream_in_V_dout),
    .stream_in_V_empty_n(sig_width48router_stream_in_V_empty_n),
    .stream_in_V_read(sig_width48router_stream_in_V_read),
    .stream_out_network_V_din(sig_width48router_stream_out_network_V_din),
    .stream_out_network_V_full_n(sig_width48router_stream_out_network_V_full_n),
    .stream_out_network_V_write(sig_width48router_stream_out_network_V_write),
    .stream_out_switch_V_din(sig_width48router_stream_out_switch_V_din),
    .stream_out_switch_V_full_n(sig_width48router_stream_out_switch_V_full_n),
    .stream_out_switch_V_write(sig_width48router_stream_out_switch_V_write),
    .ap_rst(sig_width48router_ap_rst),
    .ap_clk(aclk),
    .network_addr_V(network_addr_V)
);

width48router_network_table_V_if width48router_network_table_V_if_U(
    .clk(aclk),
    .reset(sig_width48router_ap_rst_n),
    .network_table_V_address0(sig_width48router_network_table_V_address0),
    .network_table_V_ce0(sig_width48router_network_table_V_ce0),
    .network_table_V_q0(sig_width48router_network_table_V_q0),
...
width48router_stream_in_V_if width48router_stream_in_V_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .stream_in_V_dout(sig_width48router_stream_in_V_dout),
    .stream_in_V_empty_n(sig_width48router_stream_in_V_empty_n),
...
width48router_stream_out_network_V_if width48router_stream_out_network_V_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .stream_out_network_V_din(sig_width48router_stream_out_network_V_din),
    .stream_out_network_V_full_n(sig_width48router_stream_out_network_V_full_n),
...
width48router_stream_out_switch_V_if width48router_stream_out_switch_V_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .stream_out_switch_V_din(sig_width48router_stream_out_switch_V_din),
    .stream_out_switch_V_full_n(sig_width48router_stream_out_switch_V_full_n),
...
width48router_ap_rst_if #(
    .RESET_ACTIVE_LOW(RESET_ACTIVE_LOW))
ap_rst_if_U(
    .dout(sig_width48router_ap_rst),
    .din(aresetn));
