...
set Library     "hls"
set IPName      "width48router"
set Version     "1.0"
set DisplayName "Width48router"
set Revision    "2005252107"
...
set Interfaces {
    ...
    stream_out_network_V {
        type "axi4stream"
        mode "master"
        port_prefix "stream_out_network_V"
        has_tready "1"
        ports {
            TDATA 64
            TDEST 8
    ...
    stream_out_switch_V {
        type "axi4stream"
        mode "master"
        port_prefix "stream_out_switch_V"
        has_tready "1"
        ports {
            TDATA 64
            TDEST 8
    ...
    aclk {
        type "clock"
        buses "stream_in_V stream_out_network_V stream_out_switch_V"
    }
    aresetn {
        type "reset"
    }
