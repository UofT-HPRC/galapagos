...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 1 \
    name network_table_V \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename network_table_V \
    op interface \
    ports { network_table_V_address0 { O 8 vector } network_table_V_ce0 { O 1 bit } network_table_V_q0 { I 48 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'network_table_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_network_addr_V \
    op interface \
    ports { network_addr_V { I 48 vector } } \
} "
}
