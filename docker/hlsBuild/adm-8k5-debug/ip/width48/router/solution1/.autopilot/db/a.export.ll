; ModuleID = '/home/user/galapagos/hlsBuild/adm-8k5-debug/ip/width48/router/solution1/.autopilot/db/a.o.2.bc'
...
define void @router([256 x i48]* %network_table_V, i48 %network_addr_V, i89* %stream_in_V, i89* %stream_out_switch_V, i89* %stream_out_network_V) {
  ...
  %network_addr_V_read = call i48 @_ssdm_op_Read.ap_auto.i48(i48 %network_addr_V)
...
; <label>:1                                       ; preds = %0
  ...
  %network_table_V_addr = getelementptr [256 x i48]* %network_table_V, i64 0, i64 %tmp_2
  %network_addr_in_V = load i48* %network_table_V_addr, align 8
  %inFPGA = icmp eq i48 %network_addr_in_V, %network_addr_V_read
