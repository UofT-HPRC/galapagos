...
"0": [ "ap_uint<32>", {"struct": [[{"pack": 0}],[{"_AP_W":[[], {"scalar": { "int": 32}}]}],[],""]}], 
...
set C_modelArgList {
	{ network_table_V int 32 regular {array 256 { 1 3 } 1 1 }  }
	{ network_addr_V int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "network_table_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "network_table.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 255,"step" : 1}]}]}]} , 
 	{ "Name" : "network_addr_V", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "network_addr.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ network_table_V_q0 sc_in sc_lv 32 signal 0 } 
	{ network_addr_V sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "network_table_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "network_table_V", "role": "q0" }} , 
 	{ "name": "network_addr_V", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "network_addr_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	network_table_V { ap_memory {  { network_table_V_address0 mem_address 1 8 }  { network_table_V_ce0 mem_ce 1 1 }  { network_table_V_q0 mem_dout 0 32 } } }
	network_addr_V { ap_none {  { network_addr_V in_data 0 32 } } }
