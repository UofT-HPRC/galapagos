...
port (
    ...
    network_table_V_q0 : IN STD_LOGIC_VECTOR (31 downto 0);
...
architecture behav of width32router is 
    ...
    "width32router,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku115-flva1517-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=2.911000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=216,HLS_SYN_LUT=59}";
    ...
    signal network_addr_V_read_reg_122 : STD_LOGIC_VECTOR (31 downto 0);
