...
#ifndef _width32router_HH_
#define _width32router_HH_
...
struct width32router : public sc_module {
    // Port declarations 15
    sc_in_clk ap_clk;
    sc_in< sc_logic > ap_rst;
    sc_out< sc_lv<8> > network_table_V_address0;
    sc_out< sc_logic > network_table_V_ce0;
    sc_in< sc_lv<32> > network_table_V_q0;
    sc_in< sc_lv<32> > network_addr_V;
    sc_in< sc_lv<89> > stream_in_V_dout;
    sc_in< sc_logic > stream_in_V_empty_n;
    sc_out< sc_logic > stream_in_V_read;
    sc_out< sc_lv<89> > stream_out_switch_V_din;
    sc_in< sc_logic > stream_out_switch_V_full_n;
    sc_out< sc_logic > stream_out_switch_V_write;
    sc_out< sc_lv<89> > stream_out_network_V_din;
    sc_in< sc_logic > stream_out_network_V_full_n;
    sc_out< sc_logic > stream_out_network_V_write;


    // Module declarations
    width32router(sc_module_name name);
    SC_HAS_PROCESS(width32router);
    ...
    sc_signal< sc_lv<32> > network_addr_V_read_reg_122;
    ...
    sc_signal< sc_lv<89> > tmp26_reg_131;
    sc_signal< sc_lv<89> > tmp26_reg_131_pp0_iter1_reg;
    sc_signal< sc_lv<1> > inFPGA_fu_117_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_lv<64> > tmp_2_fu_112_p1;
    sc_signal< bool > ap_block_pp0_stage0_01001;
    sc_signal< sc_lv<8> > tmp_dest_V_fu_102_p4;
    ...
    void thread_network_table_V_address0();
    void thread_network_table_V_ce0();
    ...
    void thread_tmp_dest_V_fu_102_p4();
