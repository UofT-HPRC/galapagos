...
set C_modelArgMapList {[ 
	{ "Name" : "from_app_V", "interface" : "fifo", "bitwidth" : 89, "direction" : "READONLY"} , 
 	{ "Name" : "to_raw_V", "interface" : "fifo", "bitwidth" : 73, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ from_app_V_dout sc_in sc_lv 89 signal 0 } 
	{ from_app_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ from_app_V_read sc_out sc_logic 1 signal 0 } 
	{ to_raw_V_din sc_out sc_lv 73 signal 1 } 
	{ to_raw_V_full_n sc_in sc_logic 1 signal 1 } 
	{ to_raw_V_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
