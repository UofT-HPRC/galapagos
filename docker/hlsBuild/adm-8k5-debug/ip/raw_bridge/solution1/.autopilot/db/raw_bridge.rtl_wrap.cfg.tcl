...
set DataType1 [list "raw_axis" "struct raw_axis" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
...
set DataType3 [list "raw_axis" "struct raw_axis" $structMem3 1 0 $structParameter3 $structArgument3 $NameSpace3 $structIsPacked3]
