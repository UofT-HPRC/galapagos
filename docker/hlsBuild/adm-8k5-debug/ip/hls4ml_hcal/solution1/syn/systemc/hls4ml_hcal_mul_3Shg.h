...
#ifndef __hls4ml_hcal_mul_3Shg__HH__
#define __hls4ml_hcal_mul_3Shg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls4ml_hcal_mul_3Shg) {
    ...
    SC_CTOR(hls4ml_hcal_mul_3Shg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
