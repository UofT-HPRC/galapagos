...
#ifndef __hls4ml_hcal_mul_1jbC__HH__
#define __hls4ml_hcal_mul_1jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls4ml_hcal_mul_1jbC) {
    ...
    SC_CTOR(hls4ml_hcal_mul_1jbC):  ACMP_mul_us_U ("ACMP_mul_us_U") {
