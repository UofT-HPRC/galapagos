...
#ifndef __hls4ml_hcal_mul_3Yie__HH__
#define __hls4ml_hcal_mul_3Yie__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls4ml_hcal_mul_3Yie) {
    ...
    SC_CTOR(hls4ml_hcal_mul_3Yie):  ACMP_mul_su_U ("ACMP_mul_su_U") {
