...
#ifndef __hls4ml_hcal_mul_1Bew__HH__
#define __hls4ml_hcal_mul_1Bew__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls4ml_hcal_mul_1Bew) {
    ...
    SC_CTOR(hls4ml_hcal_mul_1Bew):  ACMP_mul_us_U ("ACMP_mul_us_U") {
