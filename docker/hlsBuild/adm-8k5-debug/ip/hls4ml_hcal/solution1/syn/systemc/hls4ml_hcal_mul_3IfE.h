...
#ifndef __hls4ml_hcal_mul_3IfE__HH__
#define __hls4ml_hcal_mul_3IfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls4ml_hcal_mul_3IfE) {
    ...
    SC_CTOR(hls4ml_hcal_mul_3IfE):  ACMP_mul_su_U ("ACMP_mul_su_U") {
