...
set ID 392
set MemName hls4ml_hcal_in_bu0iy
...
# Memory (RAM/ROM)  definition:
set ID 393
set MemName hls4ml_hcal_out_bbun
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 512
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_r_TVALID { I 1 bit } in_r_TREADY { O 1 bit } in_r_TKEEP { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TVALID { O 1 bit } out_r_TREADY { I 1 bit } out_r_TKEEP { O 8 vector } } \
} "
} else {
